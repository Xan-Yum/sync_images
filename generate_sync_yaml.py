...
def get_repo_aliyun_tags(image):
    ...
    token_url = "https://dockerauth.cn-qingdao.aliyuncs.com/auth?scope=repository:waluna/{image}:pull&service=registry.aliyuncs.com:cn-qingdao:26842".format(
        image=image_name)
    try:
    ...
    tag_url = "https://registry.cn-qingdao.aliyuncs.com/v2/waluna/{image}/tags/list".format(image=image_name)
